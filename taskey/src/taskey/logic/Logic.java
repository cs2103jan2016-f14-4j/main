...
public class Logic {
	...
	LogicFeedback clear(ArrayList<ArrayList<Task>> originalCopy, ArrayList<ArrayList<Task>> modifiedCopy) {
	...
	LogicFeedback addFloating(ArrayList<ArrayList<Task>> originalCopy, ArrayList<ArrayList<Task>> modifiedCopy, 
			                  ProcessedObject po) {
	...
	LogicFeedback addDeadline(ArrayList<ArrayList<Task>> originalCopy, ArrayList<ArrayList<Task>> modifiedCopy, 
			                  ProcessedObject po) {
		Task task = po.getTask();
	...
	LogicFeedback addEvent(ArrayList<ArrayList<Task>> originalCopy, ArrayList<ArrayList<Task>> modifiedCopy, 
            	           ProcessedObject po) {
		Task task = po.getTask();
	...
	LogicFeedback deleteByIndex(ContentBox currentContent, ArrayList<ArrayList<Task>> originalCopy, 
	...
	// Removes an indexed task from the current tab and saves the updated lists to disk.
	// TODO: support removal from the "ACTION" tab.
	LogicFeedback deleteByName(ContentBox currentContent, ArrayList<ArrayList<Task>> originalCopy, 
            				   ArrayList<ArrayList<Task>> modifiedCopy, ProcessedObject po) {
		if (currentContent.equals(ContentBox.ACTION)) { 
			return new LogicFeedback(originalCopy, po, new Exception(LogicConstants.MSG_EXCEPTION_DELETE_INVALID_TAB));
		}
	...
	LogicFeedback search(ArrayList<ArrayList<Task>> originalCopy, ProcessedObject po) {
	...
	LogicFeedback doneByIndex(ContentBox currentContent, ArrayList<ArrayList<Task>> originalCopy, 
			                  ArrayList<ArrayList<Task>> modifiedCopy, ProcessedObject po) {
		Task toMarkAsDone;
		int taskIndex = po.getIndex();
		String exceptionMsg;
	...
	// TODO: support "done" from the "ACTION" tab. 
	LogicFeedback doneByName(ContentBox currentContent, ArrayList<ArrayList<Task>> originalCopy, 
    						 ArrayList<ArrayList<Task>> modifiedCopy, ProcessedObject po) {
		String taskName = po.getTask().getTaskName();
		String exceptionMsg;
	...
	LogicFeedback updateByIndexChangeName(ContentBox currentContent, ArrayList<ArrayList<Task>> originalCopy, 
			                              ArrayList<ArrayList<Task>> modifiedCopy, ProcessedObject po) {
		int taskIndex = po.getIndex();
	...
	// TODO: support "set" from the "ACTION" tab. 
	LogicFeedback updateByIndexChangeDate(ContentBox currentContent, ArrayList<ArrayList<Task>> originalCopy, 
            							  ArrayList<ArrayList<Task>> modifiedCopy, ProcessedObject po) {
		int taskIndex = po.getIndex();
	...
	// TODO: support "set" from the "ACTION" tab. 
	LogicFeedback updateByIndexChangeBoth(ContentBox currentContent, ArrayList<ArrayList<Task>> originalCopy, 
			  							  ArrayList<ArrayList<Task>> modifiedCopy, ProcessedObject po) {
		int taskIndex = po.getIndex();
		String newTaskName = po.getNewTaskName();
		Task changedTask = po.getTask();
	...
	// TODO: support "set" from the "ACTION" tab. 
	LogicFeedback updateByNameChangeName(ContentBox currentContent, ArrayList<ArrayList<Task>> originalCopy, 
										 ArrayList<ArrayList<Task>> modifiedCopy, ProcessedObject po) {
	...
	// TODO: support "set" from the "ACTION" tab. 
	LogicFeedback updateByNameChangeDate(ContentBox currentContent, ArrayList<ArrayList<Task>> originalCopy, 
			 							 ArrayList<ArrayList<Task>> modifiedCopy, ProcessedObject po) {
		Task changedTask = po.getTask();
	...
	// TODO: support "set" from the "ACTION" tab. 
	LogicFeedback updateByNameChangeBoth(ContentBox currentContent, ArrayList<ArrayList<Task>> originalCopy, 
			 							 ArrayList<ArrayList<Task>> modifiedCopy, ProcessedObject po) {
		Task changedTask = po.getTask();
