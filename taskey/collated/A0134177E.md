...
```
###### src\logic\ChangeSaveDirectory.java
``` java
 * This class encapsulates the instructions that the receiver, LogicMemory, must perform in order to facilitate the 
...
```
###### src\logic\CommandExecutor.java
``` java
...
```
###### src\logic\DeleteByTagName.java
``` java
 * This class encapsulates the instructions that the receiver, LogicMemory, must perform in order to facilitate the 
 * deleting of indexed tasks. 
 */
...
```
###### src\logic\UpdateByIndexChangeBoth.java
``` java
 * This class encapsulates the instructions that the receiver, LogicMemory, must perform in order to facilitate the 
...
```
###### src\logic\UpdateByIndexChangeDate.java
``` java
 * This class encapsulates the instructions that the receiver, LogicMemory, must perform in order to facilitate the 
...
```
###### src\logic\UpdateByIndexChangeName.java
``` java
 * This class encapsulates the instructions that the receiver, LogicMemory, must perform in order to facilitate the 
...
```
###### src\logic\UpdateByIndexChangePriority.java
``` java
 * This class encapsulates the instructions that the receiver, LogicMemory, must perform in order to facilitate the 
