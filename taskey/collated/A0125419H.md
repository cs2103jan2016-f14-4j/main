...
```
###### src\constants\UiConstants.java
``` java
...
```
###### src\ui\content\UiActionFormatter.java
``` java
...
```
###### src\ui\content\UiCategoryFormatter.java
``` java
...
```
###### src\ui\content\UiContentManager.java
``` java
...
```
###### src\ui\content\UiDefaultFormatter.java
``` java
...
```
###### src\ui\content\UiFormatter.java
``` java
...
```
###### src\ui\content\views\UiPagination.java
``` java
...
```
###### src\ui\content\views\UiTaskView.java
``` java
...
```
###### src\ui\UiAlertsController.java
``` java
 * 
...
```
###### src\ui\utility\UiAnimationManager.java
``` java
...
```
###### src\ui\utility\UiGridHelper.java
``` java
...
```
###### src\ui\utility\UiGridSettings.java
``` java
...
```
###### src\ui\utility\UiPopupManager.java
``` java
...
```
###### src\ui\utility\UiTextBuilder.java
``` java
